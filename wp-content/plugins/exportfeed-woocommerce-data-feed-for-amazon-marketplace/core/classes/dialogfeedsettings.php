                   ...
                   <table class="form-table update-table">
                      <tbody>
                        <tr>
                          ...
                          <span>
                            <input class="button-primary" style="margin-left:30px;" type="submit" value="Update Interval" id="submit" name="submit" onclick="amwscp_doUpdateSetting(\'selectDelay\', \'amwscpf_feed_delay\')">
                          </span>
                        </div>
                      </td>
                        </tr>
