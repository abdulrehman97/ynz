            ...
            if ($this->getter('id') && $this->getter('id') !== 'false') {
                ...
                if ($awsResponse === true) {
                    ...
                    if (!$check) {
                        ...
                        $this->response['message'] = "Account saved, now you are ready for uplading the products.";
                        $this->response['link'] = '<span style="color:red">' . $this->accountDetails['title'] . ' is almost saved. Would you like to make it default? <a href="?page=amwscpf-feed-account&action=default&id=' . $account_id . '">Yes</a> <a href="?page=amwscpf-feed-account">No</a></span>';
                        if (!$this->db->last_error) {
                            $this->save('insert');
                            $this->response['success'] = true;
                            return true;
