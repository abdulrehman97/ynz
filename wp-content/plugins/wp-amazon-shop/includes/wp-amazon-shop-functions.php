...
if(is_admin()){
    if (isset($_GET['page']) && ($_GET['page']=='wp-amazon-shop' || $_GET['page']=='wp-amazon-shop-basic-import' || $_GET['page']=='wp-amazon-shop-products-import' || $_GET['page']=='wp-amazon-shop-products-import-ext' || $_GET['page']=='wp-amazon-shop-info-page')) {
                ...
                <div class="wpas-pro-upgrade-notice">
                    <div>
                        <p><?php _e('If you like ', 'wp-amaxon-shop') ?><strong><?php _e('WP Amazon Shop', 'wp-amaxon-shop') ?></strong>
                            ...
                            <a target="_blank"
                               href="https://wordpress.org/support/plugin/wp-amazon-shop/reviews/#new-post"
