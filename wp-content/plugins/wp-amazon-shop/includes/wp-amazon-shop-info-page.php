...
class ACL_Amazon_Shop_Info_Page
{
                ...
                <div id="post-body" class="metabox-holder columns-2">
                    ...
                    <div id="post-body-content" style="position: relative;">
                        <div class="wpas-info-page-container">
                            ...
                            <p><strong style="color:orange"> <i class="dashicons dashicons-megaphone"></i><?php _e('Breaking News','wp-amazon-shop');?> : </strong>
                                <strong style="color:blue"> Install <a target="_blank" href="https://chrome.google.com/webstore/detail/wp-amazon-shop-extension/chlnealbecgihlcianbcpdjjbabhdgnm"><?php _e('WP Amazon Shop Chrome Extension','wp-amazon-shop');?></a> <?php _e(' and import more details of the products','wp-amazon-shop');?></strong>
                            </p>
                            <p>
                            ...
                            <p><?php _e('Getting started with','wp-amazon-shop');?>  <strong><?php _e('Wp Amazon shop','wp-amazon-shop');?> </strong> <?php _e('instantly after installing the plugin and giving only the','wp-amazon-shop');?> <strong><?php _e('Amazon Affiliate Account Tag','wp-amazon-shop');?> </strong> <?php _e('on the','wp-amazon-shop');?>
                                <a href="<?php echo get_admin_url(); ?>admin.php?page=wp-amazon-shop&tab=wpas_amazon"><?php _e('WP Amazon Shop Settings', 'wp-amazon-shop') ?></a>
                                <?php _e('page.','wp-amazon-shop');?>
                            </p>
                            <h3><?php _e('Key Features','wp-amazon-shop');?></h3>
                            <ol style="list-style:disc">
                                <li><?php _e('Extended products import by','wp-amazon-shop');?> <a target="_blank" href="https://chrome.google.com/webstore/detail/wp-amazon-shop-extension/chlnealbecgihlcianbcpdjjbabhdgnm"><?php _e('WP Amazon Shop Chrome Extension','wp-amazon-shop');?></a> </li>
                                ...
                                <li><strong><?php _e('Global Amazon Product Search Box','wp-amazon-shop');?> </strong> : <?php _e('From Setting page If Enable Amazon Products Search Globally option is checked then it will work for all search forms across your website. You may disable this feature by uncheck marked the option','wp-amazon-shop');?>
                                </li>
                            ...
                            <p style="text-align: center">
                                <a target="_blank"
                                   href="https://www.wpamazonshop.com"
                        ...
                        <div style="padding: 15px 10px; border: 1px solid #ccc; text-align: center; margin-top: 20px;">
                            <?php _e('Developed By','wp-amazon-shop');?> : <a href="http://www.amadercode.com" target="_blank"> <?php _e('Web & Mobile Application Developer Company','wp-amazon-shop');?> </a> - AmaderCode Lab
                        </div>
    ...
    function pro_version_upgrade_action($actions, $plugin_file)
    {
        ...
        if ($plugin == $plugin_file) {
            $site_link = array('settings' => '<a href="' . $upgrade_link . '" target="_blank"><span class="wpas-upgrade-link-text" style="font-weight: bold; color: orange">' . __('See Pro Features', 'wp-amazon-shop') . '</span></a>');
