...
class WPLA_InventoryCheck extends WPLA_Model  {
	...
	public function showProductInventoryCheckResult( $mode = 'published' ) {
		...
		$published_count      = isset( $tmp_result['published_count'] ) ? $tmp_result['published_count'] : array();
		$compare_prices       = isset( $tmp_result['compare_prices'] ) ? $tmp_result['compare_prices'] : array();
		$mode                 = isset( $tmp_result['mode'] ) ? $tmp_result['mode'] : array();
