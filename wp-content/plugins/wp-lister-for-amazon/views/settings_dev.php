						...
						<div class="inside">
							...
							<p class="desc" style="display: block;">
								...
								<?php if ( $wpl_text_log_level > 1 ): ?>
									...
									<?php echo __( 'Current log file size', 'wp-lister-for-amazon' ); ?>: <?php echo round($wpl_log_size/1024/1024,1) ?> mb
									[<a href="<?php $upl=wp_get_upload_dir(); echo $upl['baseurl'] ?>/wp-lister/wpla.log" target="_blank">view log</a>]
									<?php if ( file_exists( WPLA()->logger->file_prev ) ) : ?>
										[<a href="<?php $upl=wp_get_upload_dir(); echo $upl['baseurl'] ?>/wp-lister/wpla-old.log" target="_blank">view previous log</a>]
