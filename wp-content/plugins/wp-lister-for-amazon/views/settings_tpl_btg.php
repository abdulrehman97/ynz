							...
							<div id="submitpost" class="submitbox">
								...
								<div id="major-publishing-actions">
									<div id="publishing-action">
										<a href="#" onclick="jQuery('.wpla_categories input').attr('checked',false);return false;" class="button button-secondary"><?php echo __( 'Deselect all', 'wp-lister-for-amazon' ); ?></a>
						...
						<div class="inside">
							...
							<?php foreach ( $wpl_installed_templates as $template ) : ?>
								...
								<li>
									...
									<?php if ( 'fptcustom' != substr( $template->name, 0, 9 ) && $template->name != 'Offer' && $template->name != 'InventoryLoader' && $template->name != 'bookloader' ) : ?>
										<small style="color:darkred;">Warning: This template is outdated and needs to be replaced by an updated version!</small><br>
									<?php endif; ?>
