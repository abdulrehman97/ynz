							...
							<div id="submitpost" class="submitbox">
								...
								<div id="major-publishing-actions">
									<div id="publishing-action">
										...
										<input type="hidden" name="return_to"      value="<?php echo isset($_GET['return_to'])      ? wpla_clean($_GET['return_to']) : '' ?>" />
										<input type="hidden" name="listing_status" value="<?php echo isset($_GET['listing_status']) ? wpla_clean($_GET['listing_status']) : '' ?>" />
										<input type="hidden" name="profile_id"     value="<?php echo isset($_GET['profile_id'])     ? wpla_clean($_GET['profile_id']) : '' ?>" />
										<input type="hidden" name="account_id"     value="<?php echo isset($_GET['account_id'])     ? wpla_clean($_GET['account_id']) : '' ?>" />
