					...
					<div class="postbox" id="RepricingSettingsBox">
						...
						<div class="inside">
							...
							<select id="wpl-pricing_info_expiry_time" name="wpla_pricing_info_expiry_time" class=" required-entry select">
								<option value=""   <?php if ( $wpl_pricing_info_expiry_time == ''   ): ?>selected="selected"<?php endif; ?>><?php echo __( 'Off', 'wp-lister-for-amazon' ); ?></option>
							...
							<select id="wpl-pricing_info_process_oos_items" name="wpla_pricing_info_process_oos_items" class=" required-entry select">
								<option value="0" <?php if ( $wpl_pricing_info_process_oos_items == '0' ): ?>selected="selected"<?php endif; ?>><?php echo __( 'No', 'wp-lister-for-amazon' ); ?></option>
                            ...
                            <label for="wpl-text-repricing_shipping" class="text_label">
                                <?php echo __( 'Repricing Shipping', 'wp-lister-for-amazon' ); ?>
					...
					<div class="postbox adv_options" id="ColorMapBox">
						...
						<div class="inside">
							...
							<table id="color-map-table">
								...
								<?php for ($i=0; $i < sizeof($wpl_variation_color_map); $i++) : ?> 
								<tr>
									<td>
							...
							<table id="size-map-table">
								...
								<?php
									...
									$amazon_size_values = apply_filters( 'wpla_amazon_size_values', array(
                                        ...
                                        'One Size', 'XXXXX-Small', 'XXXX-Small', '3X-Small', 'XXX-Small', 'XX-Small', 'X-Small', 'Small', 'Medium',
								...
								<tr>
									...
									<td>
										<select name="sizemap_amazon[]" class="select">
											<option value=""      				<?php if ( @$wpl_sizemap_amazon[$i] == ''      				): ?>selected="selected"<?php endif; ?>>-- <?php echo __( 'Select Amazon size', 'wp-lister-for-amazon' ); ?> --</option>
							                <?php foreach ($amazon_size_values as $clr) : ?>
												<option value="<?php echo $clr ?>"   <?php if ( $wpl_sizemap_amazon[$i] == $clr ):   ?>selected="selected"<?php endif; ?>><?php echo $clr ?></option>
							                <?php endforeach; ?>
										</select>
									</td>
								</tr>
